...
import com.example.weather_app.Adapter.ForecastAdapter
...
//ใช้ในการแสดงข้อมูลสภาพอากาศปัจจุบันและพยากรณ์อากาศในอนาคต
            ...
            weatherViewModel.loadCurrentWeather(lat,lon,"metric").enqueue(object :
                ...
                override fun onResponse(
                    ...
                    if(response.isSuccessful){
                        ...
                        detaiLayout.visibility=View.VISIBLE
                        data?.let {
...
// rio, tokyo, bangkok, nong khai, khon kaen, bola
